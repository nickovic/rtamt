...
class STLEvaluator(STLVisitor):
    ...
    def visitPredicate(self, element, args):
        ...
        if (self.spec.semantics == rtamt.spec.stl.discrete_time.specification.Semantics.OUTPUT_ROBUSTNESS and not element.out_vars):
            out_sample.value = out_sample.value*float('inf')
        elif(self.spec.semantics == rtamt.spec.stl.discrete_time.specification.Semantics.INPUT_VACUITY and not element.in_vars):
            out_sample.value = 0
        elif(self.spec.semantics == rtamt.spec.stl.discrete_time.specification.Semantics.INPUT_ROBUSTNESS and not element.in_vars):
            out_sample.value = out_sample.value*float('inf')
        elif(self.spec.semantics == rtamt.spec.stl.discrete_time.specification.Semantics.OUTPUT_VACUITY and not element.out_vars):
            out_sample.value = 0
