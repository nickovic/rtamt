...
if V(_antlr_runtime_version) <= V("4.9.3"):
    from rtamt.antlr.parser.stl.antlr_4_9 import LtlLexer, StlParser, StlParserVisitor
else:
    from rtamt.antlr.parser.stl.antlr_4_13 import LtlLexer, StlParser, StlParserVisitor
