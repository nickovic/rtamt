...
class StlParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by StlParser#ExprUnaryMinus.
    def visitExprUnaryMinus(self, ctx:StlParser.ExprUnaryMinusContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by StlParser#ExprParenRealExpr.
    def visitExprParenRealExpr(self, ctx:StlParser.ExprParenRealExprContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by StlParser#boolLiteral.
    def visitBoolLiteral(self, ctx:StlParser.BoolLiteralContext):
        return self.visitChildren(ctx)
