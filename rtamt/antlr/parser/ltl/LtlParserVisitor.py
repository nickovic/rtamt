...
class LtlParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by LtlParser#ExprUnaryMinus.
    def visitExprUnaryMinus(self, ctx:LtlParser.ExprUnaryMinusContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by LtlParser#ExprParenRealExpr.
    def visitExprParenRealExpr(self, ctx:LtlParser.ExprParenRealExprContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by LtlParser#boolLiteral.
    def visitBoolLiteral(self, ctx:LtlParser.BoolLiteralContext):
        return self.visitChildren(ctx)
