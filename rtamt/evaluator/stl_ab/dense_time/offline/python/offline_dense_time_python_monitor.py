from rtamt.spec.stl_ab.discrete_time.visitor import STLabVisitor
...
from rtamt.operation.stl_ab.dense_time.offline.and_operation import AndOperation
from rtamt.operation.stl_ab.dense_time.offline.or_operation import OrOperation
from rtamt.operation.stl_ab.dense_time.offline.implies_operation import ImpliesOperation
from rtamt.operation.stl_ab.dense_time.offline.iff_operation import IffOperation
from rtamt.operation.stl_ab.dense_time.offline.xor_operation import XorOperation
from rtamt.operation.stl_ab.dense_time.offline.since_operation import SinceOperation
from rtamt.operation.arithmetic.dense_time.offline.abs_operation import AbsOperation
from rtamt.operation.stl_ab.dense_time.offline.not_operation import NotOperation
from rtamt.operation.stl_ab.dense_time.offline.once_operation import OnceOperation
from rtamt.operation.stl_ab.dense_time.offline.historically_operation import HistoricallyOperation
from rtamt.operation.stl_ab.dense_time.offline.always_operation import AlwaysOperation
from rtamt.operation.stl_ab.dense_time.offline.until_operation import UntilOperation
from rtamt.operation.stl_ab.dense_time.offline.eventually_operation import EventuallyOperation
from rtamt.operation.stl_ab.dense_time.offline.constant_operation import ConstantOperation
from rtamt.operation.stl_ab.dense_time.offline.once_bounded_operation import OnceBoundedOperation
from rtamt.operation.stl_ab.dense_time.offline.historically_bounded_operation import HistoricallyBoundedOperation
from rtamt.operation.stl_ab.dense_time.offline.since_bounded_operation import SinceBoundedOperation
from rtamt.operation.stl_ab.dense_time.offline.always_bounded_operation import AlwaysBoundedOperation
from rtamt.operation.stl_ab.dense_time.offline.eventually_bounded_operation import EventuallyBoundedOperation
from rtamt.operation.stl_ab.dense_time.offline.until_bounded_operation import UntilBoundedOperation





class STLabOfflineDenseTimePythonMonitor(STLabVisitor):
    def __init__(self):
