  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3237143688U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2854039817U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(518448551U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(26636351U);
    } else {
      return 0;
    }
  } else {
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3473390987U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1305858295U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1723088494U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1894126595U);
  }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(instanceChksum, "ssfOuq1tq5V0V2yrSopqQ8E") == 0) {
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "ssfOuq1tq5V0V2yrSopqQ8E") == 0) {
...
unsigned int sf_sf_aircraft_fault_get_post_codegen_info( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
     ...
     case 3:
      {
        if (strcmp(tpChksum, "ssfOuq1tq5V0V2yrSopqQ8E") == 0) {
          ...
          const char* encoded_post_codegen_info =
            sf_c3_sf_aircraft_fault_get_post_codegen_info();
