#ifndef __sf_aircraft_fault_sfun_h__
#define __sf_aircraft_fault_sfun_h__
...
extern mxArray* load_sf_aircraft_fault_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_sf_aircraft_fault_optimization_info(void);
